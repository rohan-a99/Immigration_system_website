                ...
                <div class="slimscroll-menu" id="left-side-menu-container">
                    ...
                    <ul class="metismenu side-nav">
                        ...
                        <li class="side-nav-title side-nav-item">Foreigner</li>
                         ...
                         <li class="side-nav-item">
                            <a href="immigration.php" class="side-nav-link">
                                <i class="uil-store"></i>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Hey <?php echo " " .$_SESSION['username'];   ?></h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                                              ...
                                              <form class="needs-validation" novalidate>
                                                ...
                                                <div class="form-group mb-3">
                                                  ...
                                                  <select class="form-control select2" required>
                                                    ...
                                                    <optgroup label="Foreigner">
                                                        <option value="vext">Visa Extension</option>    
                                                        <option value="rpe">Resident Permit</option>
                                                    </optgroup>
