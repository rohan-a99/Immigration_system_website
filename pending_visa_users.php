...
$query="SELECT * FROM visa_1 WHERE username='$uname'";
$result=mysqli_query($connection, $query);


$query1="SELECT * FROM visa_2 WHERE username='$uname'";
$result1=mysqli_query($connection, $query1);

$query2="SELECT * FROM visa_3 WHERE username='$uname'";
$result2=mysqli_query($connection, $query2);


$query3="SELECT * FROM visa_4 WHERE username='$uname'";
$result3=mysqli_query($connection, $query3);

$query4="SELECT application_no FROM login WHERE username='$uname'";
                                          ...
                                          while ($rows=mysqli_fetch_assoc($result3)) 
                                               ...
                                               <tr>
                                                ...
                                                <tr >
                                                   ...
                                                   <th style="padding-top: 40px; padding-bottom: 40px; padding-left: 50px"><img src="<?php echo $rows['aadhar_pic']; ?>" height="200px" width="500px" ></th>
                                               </tr>
                                               ...
                                               <tr>
                                                ...
                                                <tr >
                                                   <th style="padding-bottom: 40px; padding-top: 40px; padding-left: 30px;" ><img src="<?php echo $rows['signature']; ?>" height="200px" width="500px" ></th>
                                                   <th style="padding-left: 50px"><img src="<?php echo $rows['photo']; ?>" height="200px" width="500px" ></th>
                                               </tr>
