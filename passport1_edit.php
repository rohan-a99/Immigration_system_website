...
$query1="SELECT * from passport_1 where username='$abc' and type='Tatkal'";
$result1=mysqli_query($connection,$query1);
$count=mysqli_num_rows($result1);

$query2="SELECT * from passport_1 where username='$abc' and b_type='36'";
$result2=mysqli_query($connection,$query2);
$count2=mysqli_num_rows($result2);


$query3="SELECT * from passport_1 where username='$abc' and n_ecr='y'";
                                        ...
                                        <h4 class="header-title mb-3">New Passport Application</h4>
                                            ...
                                            <div id="rootwizard">
                                                <ul class="nav nav-pills nav-justified form-wizard-header mb-3">
                                                    <li class="nav-item" data-target-form="#passForm">
                                                        <a href="#first" data-toggle="tab" class="nav-link rounded-0 pt-2 pb-2">
                                                            <i class="mdi mdi-account-circle mr-1"></i>
                                                            <span class="d-none d-sm-inline">Passport Type</span>
                                                        </a>
                                                    </li>
                                                </ul>
                                                ...
                                                <div class="tab-content mb-0 b-0">
                                                     <div class="tab-pane" id="first">
                                                        <!-- Form BY ROWS -->
                                                        <form id="passForm" method="post" action="Passport1.php" class="form-horizontal">
                                                            <div class="row">
                                                                  <div class="col">
                                                                <div class="form-group mb-4">
                                                                    <label class="col-md-7 col-form-label" for="userName3">Application Category</label>
                                                                    <div class="col-md-12">
                                                                ...
                                                                <div class="col">
                                                                <div class="form-group mb-4">
                                                                    <label class="col-md-7 col-form-label" for="userName3">Citizen Category</label>
                                                                    <div class="col-md-12">
                                                                    <select id="inputState" class="form-control" name="category" required>
                                                                        ...
                                                                        <option style="display: 
                                                                          ...
                                                                          if($rows['category']== 'Senior Citizen')
                                                                          {
                                                                            echo "none";
                                                                          }
                                                                ...
                                                                <div class="col mb-3">
                                                                    ...
                                                                    <label class="col-sm-4 col-form-label" for="userName3">Type of Booklet</label>
                                                                <div class="custom-control custom-radio custom-control-inline">
                                                                    <input type="radio" id="customRadio3" name="book_type" class="custom-control-input" value="36" 
                                                                     ...
                                                                     required>
                                                                    <label class="custom-control-label" for="customRadio3">36 Pages</label>
                                                                </div> 
                                                                <div class="custom-control custom-radio custom-control-inline">
                                                                    <input type="radio" id="customRadio4" name="book_type" class="custom-control-input" value="60"
                                                                        ...
                                                                        <?php   
                                                                           ...
                                                                           required>
                                                                    <label class="custom-control-label" for="customRadio4">60 Pages</label>
                                                                </div>
                                                                 ...
                                                                 <div class="col mb-3">
                                                                    <div class="form-group mt-3">
                                                                    <label class="col-sm-4 col-form-label" for="userName3">Eligible for Non-ECR</label>
                                                                <div class="custom-control custom-radio custom-control-inline">
                                                                    <input type="radio" id="customRadio1" name="n_ecr" class="custom-control-input" value="y"
                                                                ...
                                                                <div class="custom-control custom-radio custom-control-inline">
                                                                    <input type="radio" id="customRadio13" name="n_ecr" class="custom-control-input" value="n"
