                                            ...
                                            <div id="rootwizard">
                                                <ul class="nav nav-pills nav-justified form-wizard-header mb-3">
                                                    ...
                                                    <li class="nav-item" data-target-form="#profileForm">
                                                        <a href="#second" data-toggle="tab" class="nav-link rounded-0 pt-2 pb-2">
                                                            ...
                                                            <span class="d-none d-sm-inline">Visa Information</span>
                                                        </a>
                                                    </li>
                                                </ul>
                                                ...
                                                <div class="tab-content mb-0 b-0">
                                                    ...
                                                    <div class="tab-pane fade" id="second">
                                                        <form id="profileForm" method="post" action="visaren2.php" class="form-horizontal">
                                                            <div class="row">
                                                                
                                                                <div class="col">
                                                                    <div class="form-group mb-3">
                                                                        <label class="col-md-3 col-form-label" for="userName3">Visa no</label>
                                                                        <div class="col-md-12">
                                                                            <input type="text" class="form-control" data-toggle="input-mask" name="v_nm" data-mask-format="00 0000-0000" name="v_nm" required>
                                                                        </div>
                                                                    </div>
                                                                </div> <!-- end col -->
                                                                 ...
                                                                 <div class="col">
                                                                <div class="form-group mb-3">
                                                                    <label class="col-md-3 col-form-label" for="userName3">Visa Type</label>
                                                                    <div class="col-md-9">
                                                                    <select class="form-control" name="vt" required>
                                                                ...
                                                                <div class="col">
                                                                    <div class="form-group mb-3">
                                                                        <label class="col-md-3 col-form-label" for="userName3">Visa Issue Date</label>
                                                                        <div class="col-md-12">
                                                                            <input class="form-control" id="example-date" type="date" name="vidate" required>
                                                                        </div>
                                                                    </div>
                                                                </div> <!-- end col -->
                                                                ...
                                                                <div class="col">
                                                                    <div class="form-group mb-3">
                                                                        <label class="col-md-3 col-form-label" for="userName3">Visa Expiry Date</label>
                                                                        <div class="col-md-9">
                                                                            <input class="form-control" id="example-date" type="date" name="vedate" required>
                                                                        </div>
                                                                    </div>
                                                                </div> <!-- end col -->
                                                                ...
                                                                <div class="w-100"></div> <!----------------------  DIVIDE   ------------------------->
                                                                 ...
                                                                 <div class="col">
                                                                    <div class="form-group mb-3">
                                                                        <label class="col-md-7 col-form-label" for="userName3">Reason For Extension</label>
                                                                        <div class="col-md-12">
                                                                            <input type="text" class="form-control" data-toggle="input-mask" name="reason" required>
                                                                        </div>
                                                                    </div>
                                                                </div> <!-- end col -->
                                                                ...
                                                                <div class="col">
                                                                    <div class="form-group mb-3">
                                                                        <label class="col-md-7 col-form-label" for="userName3">Visa Extension needed till</label>
                                                                        <div class="col-md-9">
                                                                            <input class="form-control" id="example-date" type="date" name="veneeded" required>
                                                                        </div>
                                                                    </div>
                                                                </div> <!-- end col -->
                                                    ...
                                                    <ul class="list-inline wizard mb-0">
                                                        ...
                                                        <li class="next list-inline-item float-right"><a href="final_form_visa_form.php"><button class="btn btn-info" type="submit">Next</button></a></li>
                                                    </ul>
