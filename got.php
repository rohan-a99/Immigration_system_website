                    ...
                    <ul class="metismenu side-nav">
                        ...
                        <li class="side-nav-item">
                            ...
                            <ul class="side-nav-second-level" aria-expanded="false">
                                <li>
                                    <a href="New.html">New Passport</a>
                                </li>
                                <li>
                                    <a href="passport_renewal.html">Passport Renewal</a>
                                </li>
                        ...
                        <ul class="list-unstyled topbar-right-menu float-right mb-0">
                            ...
                            <li class="dropdown notification-list">
                                <a class="nav-link dropdown-toggle nav-user arrow-none mr-0" data-toggle="dropdown" href="#" role="button" aria-haspopup="false"
                                    ...
                                    <span>
                                        <span class="account-user-name">Adarsh Unnikrishnan</span>
                                            ...
                                            Here’s the fastest way to check the status of your Application. No need to call Customer Service – our online results give you real-time, detailed progress as your Application.
                                              ...
                                              <form class="needs-validation" novalidate>
                                                ...
                                                <div class="form-group mb-3">
                                                   <label for="example-select">Application Type</label>
                                                  <select class="form-control select2" required>
                                                      
                                                    <option value="">Select</option>
                                                    <optgroup label="Citizen">
                                                        <option value="npass">New Passport</option>
                                                        <option value="passex">Passport Extension</option>
                                                        <option value="nvisa">New Visa</option>
                                                    </optgroup>
                                                </select>
                                                </div>
