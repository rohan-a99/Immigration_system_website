                                            ...
                                            <div id="rootwizard">
                                                <ul class="nav nav-pills nav-justified form-wizard-header mb-3">
                                                    ...
                                                    <li class="nav-item" data-target-form="#profileForm">
                                                        <a href="#third" data-toggle="tab" class="nav-link rounded-0 pt-2 pb-2">
                                                            ...
                                                            <span class="d-none d-sm-inline">Origin</span>
                                                        </a>
                                                    </li>
                                                ...
                                                <div class="tab-content mb-0 b-0">
                                                    ...
                                                    <div class="tab-pane fade" id="third">
                                                        <form id="profileForm" method="post" action="Passport3.php" class="form-horizontal">
                                                            <div class="row">
                                                                <div class="col">
                                                ...
                                                <script type="text/javascript">
                                                                ...
                                                                <div class="form-group mb-4">
                                                                    ...
                                                                    <div class="col-md-12">
                                                                    <input type="text" class="form-control" id="inputZip" name="r_zip" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="w-100"></div> <!----------------------  DIVIDE   ------------------------->
                                                            ...
                                                            <div class="custom-control custom-radio custom-control-inline">
                                                                <input type="radio" id="customRadio11" name="pa" class="custom-control-input" onclick="yesnoCheck()" required>
                                                                <label class="custom-control-label" for="customRadio11">Yes</label>
                                                            </div> 
                                                            <div class="custom-control custom-radio custom-control-inline">
                                                                <input type="radio" id="customRadio12" name="pa" class="custom-control-input" onclick="yesnoCheck()" required>
                                                           ...
                                                           <div id="abc" style="display:none">
                                                                ...
                                                                <div class="form-group mb-4">
                                                                    <label class="col-md-4 col-form-label" for="userName3">State</label>
                                                                    <div class="col-md-12">
                                                                    <select id="p_inputState" class="form-control" name="p_state" onchange="check1()" >
                                                                ...
                                                                <div class="form-group mb-4">
                                                                    <label class="col-md-4 col-form-label" for="userName3">District</label>
                                                                    <div class="col-md-12"> 
                                                                    <select id="p_inputdist" class="form-control" name="p_dist" >
                                                                                                                                               <option value="">Choose</option>
                                                                        ...
                                                                        <option id="tamil_nadu1" style="display: none">Ariyalur</option>
                                                                        <option id="tamil_nadu1" style="display: none">Chennai</option>
                                                                        <option id="tamil_nadu1" style="display: none">Coimbatore</option>
                                                                        <option id="tamil_nadu1" style="display: none">Cuddalore</option>
                                                                        <option id="tamil_nadu1" style="display: none">Dharmapuri</option>
                                                                        <option id="tamil_nadu1" style="display: none">Dindigul</option>
                                                                        <option id="tamil_nadu1" style="display: none">Erode</option>
                                                                        <option id="tamil_nadu1" style="display: none">Kancheepuram</option>
                                                                        <option id="tamil_nadu1" style="display: none">Kanyakumari</option>
                                                                        <option id="tamil_nadu1" style="display: none">Karur</option>
                                                                        <option id="tamil_nadu1" style="display: none">Krishnagiri</option>
                                                                        <option id="tamil_nadu1" style="display: none">Madurai</option>
                                                                        <option id="tamil_nadu1" style="display: none">Nagapattinam</option>
                                                                        <option id="tamil_nadu1" style="display: none">Namakkal</option>
                                                                        <option id="tamil_nadu1" style="display: none">Perambalur</option>
                                                                        <option id="tamil_nadu1" style="display: none">Pudukottai</option>
                                                                        <option id="tamil_nadu1" style="display: none">Ramanathapuram</option>
                                                                        <option id="tamil_nadu1" style="display: none">Salem</option>
                                                                        <option id="tamil_nadu1" style="display: none">Sivaganga</option>
                                                                        <option id="tamil_nadu1" style="display: none">Thanjavur</option>
                                                                        <option id="tamil_nadu1" style="display: none">The Nilgiris</option>
                                                                        <option id="tamil_nadu1" style="display: none">Theni</option>
                                                                        <option id="tamil_nadu1" style="display: none">Thiruvallur</option>
                                                                        <option id="tamil_nadu1" style="display: none">Thiruvannamalai</option>
                                                                        <option id="tamil_nadu1" style="display: none">Thiruvarur</option>
                                                                        <option id="tamil_nadu1" style="display: none">Thirunelveli</option>
                                                                        <option id="tamil_nadu1" style="display: none">Tiruppur</option>
                                                                        <option id="tamil_nadu1" style="display: none">Trichirappalli</option>
                                                                        <option id="tamil_nadu1" style="display: none">Uticorin</option>
                                                                        <option id="tamil_nadu1" style="display: none">Vellore</option>
                                                                        <option id="tamil_nadu1" style="display: none">Villupuram</option>
                                                                        <option id="tamil_nadu1" style="display: none">Virudhunagar</option>
                                                                        ...
                                                                        <option id="kerela1" style="display: none">Thiruvananthapuram</option>
                                                                        <option id="kerela1" style="display: none">Kollam</option>
                                                                        <option id="kerela1" style="display: none">Alappuzha</option>
                                                                        <option id="kerela1" style="display: none">Pathanamthitta</option>
                                                                        <option id="kerela1" style="display: none">Kottayam</option>
                                                                        <option id="kerela1" style="display: none">Idukki</option>
                                                                        <option id="kerela1" style="display: none">Ernakulam</option>
                                                                        <option id="kerela1" style="display: none">Thrissur</option>
                                                                        <option id="kerela1" style="display: none">Palakkad</option>
                                                                        <option id="kerela1" style="display: none">Malappuram</option>
                                                                        <option id="kerela1" style="display: none">Kozhikode</option>
                                                                        <option id="kerela1" style="display: none">Wayanadu</option>
                                                                        <option id="kerela1" style="display: none">Kannur</option>
                                                                        <option id="kerela1" style="display: none">Kasaragod</option>


                                                                        <!--punjab(c)-->

                                                                        <option id="punjab1" style="display: none">Amritsar</option>
                                                                        <option id="punjab1" style="display: none">Barnala</option>
                                                                        <option id="punjab1" style="display: none">Bathinda</option>
                                                                        <option id="punjab1" style="display: none">Fazilka</option>
                                                                        <option id="punjab1" style="display: none">Faridkot</option>
                                                                        <option id="punjab1" style="display: none">Fatehgarh Sahib</option>
                                                                        <option id="punjab1" style="display: none">Firozpur</option>
                                                                        <option id="punjab1" style="display: none">Gurdaspur</option>
                                                                        <option id="punjab1" style="display: none">Hoshiapur</option>
                                                                        <option id="punjab1" style="display: none">Jalandhar</option>
                                                                        <option id="punjab1" style="display: none">Kapurthala</option>
                                                                        <option id="punjab1" style="display: none">Ludhiana</option>
                                                                        <option id="punjab1" style="display: none">Mansa</option>
                                                                        <option id="punjab1" style="display: none">Moga</option>
                                                                        <option id="punjab1" style="display: none">Mohali</option>
                                                                        <option id="punjab1" style="display: none">Muktsar</option>
                                                                        <option id="punjab1" style="display: none">Pathankot</option>
                                                                        <option id="punjab1" style="display: none">Patiala</option>
                                                                        <option id="punjab1" style="display: none">Rupnagar</option>
                                                                        <option id="punjab1" style="display: none">Sangrur</option>
                                                                        <option id="punjab1" style="display: none">Shahid Bhagat Singh Nagar</option>
                                                                        <option id="punjab1" style="display: none">Tarn Taran</option>
                                                                        

                                                                        
                                                                        <!--rajasthan(d)-->

                                                                        <option id="rajasthan1" style="display: none">Ajmer</option>
                                                                        <option id="rajasthan1" style="display: none">Alwer</option>
                                                                        <option id="rajasthan1" style="display: none">Banswara</option>
                                                                        <option id="rajasthan1" style="display: none">Baran</option>
                                                                        <option id="rajasthan1" style="display: none">Barmer</option>
                                                                        <option id="rajasthan1" style="display: none">Bharatpur</option>
                                                                        <option id="rajasthan1" style="display: none">Bhilwara</option>
                                                                        <option id="rajasthan1" style="display: none">Bikaner</option>
                                                                        <option id="rajasthan1" style="display: none">Bundi</option>
                                                                        <option id="rajasthan1" style="display: none">Chittorgarh</option>
                                                                        <option id="rajasthan1" style="display: none">Churu</option>
                                                                        <option id="rajasthan1" style="display: none">Dausa</option>
                                                                        <option id="rajasthan1" style="display: none">Dholpur</option>
                                                                        <option id="rajasthan1" style="display: none">Dungarpur</option>
                                                                        <option id="rajasthan1" style="display: none">Hanumangarh</option>
                                                                        <option id="rajasthan1" style="display: none">Jaipur</option>
                                                                        <option id="rajasthan1" style="display: none">Jaisalmer</option>
                                                                        <option id="rajasthan1" style="display: none">Jalor</option>
                                                                        <option id="rajasthan1" style="display: none">Jhalawar</option>
                                                                        <option id="rajasthan1" style="display: none">Jhunjhunu</option>
                                                                        <option id="rajasthan1" style="display: none">Jodhpur</option>
                                                                        <option id="rajasthan1" style="display: none">Karauli</option>
                                                                        <option id="rajasthan1" style="display: none">Kota</option>
                                                                        <option id="rajasthan1" style="display: none">Nagaur</option>
                                                                        <option id="rajasthan1" style="display: none">Pali</option>
                                                                        <option id="rajasthan1" style="display: none">Pratapgarh</option>
                                                                        <option id="rajasthan1" style="display: none">Rajsamand</option>
                                                                        <option id="rajasthan1" style="display: none">Sawai Madhopur</option>
                                                                        <option id="rajasthan1" style="display: none">Sikar</option>
                                                                        <option id="rajasthan1" style="display: none">Sirohi</option>
                                                                        <option id="rajasthan1" style="display: none">Sri Ganganagar</option>
                                                                        <option id="rajasthan1" style="display: none">Tonk</option>
                                                                        <option id="rajasthan1" style="display: none">Udaipur</option>



                                                                        <!--Andhra Pradesh(e)-->

                                                                        <option id="andhra1" style="display: none">Anantapur</option>
                                                                        <option id="andhra1" style="display: none">Chittoor</option>
                                                                        <option id="andhra1" style="display: none">East Godavari</option>
                                                                        <option id="andhra1" style="display: none">Guntur</option>
                                                                        <option id="andhra1" style="display: none">Cuddapah</option>
                                                                        <option id="andhra1" style="display: none">Krishna</option>
                                                                        <option id="andhra1" style="display: none">Kurnool</option>
                                                                        <option id="andhra1" style="display: none">Prakasam</option>
                                                                        <option id="andhra1" style="display: none">Nellore</option>
                                                                        <option id="andhra1" style="display: none">Srikakulam</option>
                                                                        <option id="andhra1" style="display: none">Vishakhapatnam</option>
                                                                        <option id="andhra1" style="display: none">Vizianagaram</option>
                                                                        <option id="andhra1" style="display: none">West Godavari</option>
                                                                        ...
                                                                        <option id="arunachal1" style="display: none">Changlang</option>
                                                                        <option id="arunachal1" style="display: none">Upper Dibang Vally</option>
                                                                        <option id="arunachal1" style="display: none">East Kameng</option>
                                                                        <option id="arunachal1" style="display: none">East Siang</option>
                                                                        <option id="arunachal1" style="display: none">Lohit</option>
                                                                        <option id="arunachal1" style="display: none">Lower Subansiri</option>
                                                                        <option id="arunachal1" style="display: none">Papum-Pare</option>
                                                                        <option id="arunachal1" style="display: none">Tawang</option>
                                                                        <option id="arunachal1" style="display: none">Tirap</option>
                                                                        <option id="arunachal1" style="display: none">Upper Siang</option>
                                                                        <option id="arunachal1" style="display: none">Upper Subansiri</option>
                                                                        <option id="arunachal1" style="display: none">West Kameng</option>
                                                                        <option id="arunachal1" style="display: none">West Siang</option>
                                                                        <option id="arunachal1" style="display: none">Anjaw</option>
                                                                        <option id="arunachal1" style="display: none">Lower Dibang Vally</option>
                                                                        <option id="arunachal1" style="display: none">Kurung Kumey</option>
                                                                        ...
                                                                        <option id="assam1" style="display: none">Baksa</option>
                                                                        <option id="assam1" style="display: none">Barpeta</option>
                                                                        <option id="assam1" style="display: none">Biswanath</option>
                                                                        <option id="assam1" style="display: none">Bongaigaon</option>
                                                                        <option id="assam1" style="display: none">Cachar</option>
                                                                        <option id="assam1" style="display: none">Charaideo</option>
                                                                        <option id="assam1" style="display: none">Chirang</option>
                                                                        <option id="assam1" style="display: none">Darrang</option>
                                                                        <option id="assam1" style="display: none">Dhemaji</option>
                                                                        <option id="assam1" style="display: none">Dhubri</option>
                                                                        <option id="assam1" style="display: none">Dibrugarh</option>
                                                                        <option id="assam1" style="display: none">Dima Hasao</option>
                                                                        <option id="assam1" style="display: none">Goalpara</option>
                                                                        <option id="assam1" style="display: none">Golaghat</option>
                                                                        <option id="assam1" style="display: none">Hailakandi</option>
                                                                        <option id="assam1" style="display: none">Hojai</option>
                                                                        <option id="assam1" style="display: none">Jorhat</option>
                                                                        <option id="assam1" style="display: none">Kamrup Metropolitan</option>
                                                                        <option id="assam1" style="display: none">Kamrup</option>
                                                                        <option id="assam1" style="display: none">Karbi Anglong</option>
                                                                        <option id="assam1" style="display: none">Karimganj</option>
                                                                        <option id="assam1" style="display: none">Kokrajhar</option>
                                                                        <option id="assam1" style="display: none">Lakhimpur</option>
                                                                        <option id="assam1" style="display: none">Majuli</option>
                                                                        <option id="assam1" style="display: none">Morigaon</option>
                                                                        <option id="assam1" style="display: none">Nagaon</option>
                                                                        <option id="assam1" style="display: none">Nalbari</option>
                                                                        <option id="assam1" style="display: none">Sivasagar</option>
                                                                        <option id="assam1" style="display: none">Sonitpur</option>
                                                                        <option id="assam1" style="display: none">South Salmara-Mankachar</option>
                                                                        <option id="assam1" style="display: none">Tinsukia</option>
                                                                        <option id="assam1" style="display: none">Udalguri</option>
                                                                        <option id="assam1" style="display: none">West Karbi Anglong</option>
                                                                        
                                                                        
                                                                         <!--Goa(h)-->
                                                                        
                                                                        <option id="goa1" style="display: none">North Goa</option>
                                                                        <option id="goa1" style="display: none">South Goa</option>

                                                                        <!--Maharashtra(ii)-->
                                                                        
                                                                        <option id="maharashtra1" style="display: none">Ahmednagar</option>
                                                                        <option id="maharashtra1" style="display: none">Akola</option>
                                                                        <option id="maharashtra1" style="display: none">Amravati</option>
                                                                        <option id="maharashtra1" style="display: none">Aurangabad</option>
                                                                        <option id="maharashtra1" style="display: none">Beed</option>
                                                                        <option id="maharashtra1" style="display: none">Bhandra</option>
                                                                        <option id="maharashtra1" style="display: none">Buldhana</option>
                                                                        <option id="maharashtra1" style="display: none">Chandrapur</option>
                                                                        <option id="maharashtra1" style="display: none">Dhule</option>
                                                                        <option id="maharashtra1" style="display: none">Gadchiroli</option>
                                                                        <option id="maharashtra1" style="display: none">Gondia</option>
                                                                        <option id="maharashtra1" style="display: none">Jalgaon</option>
                                                                        <option id="maharashtra1" style="display: none">Jalna</option>
                                                                        <option id="maharashtra1" style="display: none">Kolhapur</option>
                                                                        <option id="maharashtra1" style="display: none">Latur</option>
                                                                        <option id="maharashtra1" style="display: none">Mumbai City</option>
                                                                        <option id="maharashtra1" style="display: none">Mumbai Suburban</option>
                                                                        <option id="maharashtra1" style="display: none">Nagpur</option>
                                                                        <option id="maharashtra1" style="display: none">Nanded</option>
                                                                        <option id="maharashtra1" style="display: none">Nandurbar</option>
                                                                        <option id="maharashtra1" style="display: none">Nashik</option>
                                                                        <option id="maharashtra1" style="display: none">Osmanabad</option>
                                                                        <option id="maharashtra1" style="display: none">Parbhani</option>
                                                                        <option id="maharashtra1" style="display: none">Pune</option>
                                                                        <option id="maharashtra1" style="display: none">Raigad</option>
                                                                        <option id="maharashtra1" style="display: none">Ratnagiri</option>
                                                                        <option id="maharashtra1" style="display: none">Sangali</option>
                                                                        <option id="maharashtra1" style="display: none">Satara</option>
                                                                        <option id="maharashtra1" style="display: none">Sindhudurg</option>
                                                                        <option id="maharashtra1" style="display: none">Solapur</option>
                                                                        <option id="maharashtra1" style="display: none">Thane</option>
                                                                        <option id="maharashtra1" style="display: none">Wardha</option>
                                                                        <option id="maharashtra1" style="display: none">Washim</option>
                                                                        <option id="maharashtra1" style="display: none">Yavatmal</option>
                                                                        <option id="maharashtra1" style="display: none">Palghar</option>
                                                                        
                                                                         <!--Chattisgarh(j)-->
                                                                        
                                                                        <option id="Chattisgarh1" style="display: none">Balod</option>
                                                                        <option id="Chattisgarh1" style="display: none">Baloda Bazar</option>
                                                                        <option id="Chattisgarh1" style="display: none">Balrampur</option>
                                                                        <option id="Chattisgarh1" style="display: none">Bastar</option>
                                                                        <option id="Chattisgarh1" style="display: none">Bemetara</option>
                                                                        <option id="Chattisgarh1" style="display: none">Bijapur</option>
                                                                        <option id="Chattisgarh1" style="display: none">Bilaspur</option>
                                                                        <option id="Chattisgarh1" style="display: none">Dantewada</option>
                                                                        <option id="Chattisgarh1" style="display: none">Dhamtari</option>
                                                                        <option id="Chattisgarh1" style="display: none">Durg</option>
                                                                        <option id="Chattisgarh1" style="display: none">Gariaband</option>
                                                                        <option id="Chattisgarh1" style="display: none">Janjgir-Champa</option>
                                                                        <option id="Chattisgarh1" style="display: none">Jashpur</option>
                                                                        <option id="Chattisgarh1" style="display: none">Kabirdham</option>
                                                                        <option id="Chattisgarh1" style="display: none">Kanker</option>
                                                                        <option id="Chattisgarh1" style="display: none">Kondagaon</option>
                                                                        <option id="Chattisgarh1" style="display: none">Korba</option>
                                                                        <option id="Chattisgarh1" style="display: none">Koriya</option>
                                                                        <option id="Chattisgarh1" style="display: none">Mahasamund</option>
                                                                        <option id="Chattisgarh1" style="display: none">Mungeli</option>
                                                                        <option id="Chattisgarh1" style="display: none">Narayanpur</option>
                                                                        <option id="Chattisgarh1" style="display: none">Raigarh</option>
                                                                        <option id="Chattisgarh1" style="display: none">Raipur</option>
                                                                        <option id="Chattisgarh1" style="display: none">Rajnandgaon</option>
                                                                        <option id="Chattisgarh1" style="display: none">Sukma</option>
                                                                        <option id="Chattisgarh1" style="display: none">Surajpur</option>
                                                                        <option id="Chattisgarh1" style="display: none">Surguja</option>
                                                                        
                                                                        <!--Orissa(k)-->
                                                                        
                                                                        <option id="orissa1" style="display: none">Angul</option>
                                                                        <option id="orissa1" style="display: none">Boudh</option>
                                                                        <option id="orissa1" style="display: none">Balangir</option>
                                                                        <option id="orissa1" style="display: none">Bargarh</option>
                                                                        <option id="orissa1" style="display: none">Balasore</option>
                                                                        <option id="orissa1" style="display: none">Bhadrak</option>
                                                                        <option id="orissa1" style="display: none">Cuttack</option>
                                                                        <option id="orissa1" style="display: none">Deogarh</option>
                                                                        <option id="orissa1" style="display: none">Dhenkanal</option>
                                                                        <option id="orissa1" style="display: none">Ganjam</option>
                                                                        <option id="orissa1" style="display: none">Gajapati</option>
                                                                        <option id="orissa1" style="display: none">Jharsuguda</option>
                                                                        <option id="orissa1" style="display: none">Jajpur</option>
                                                                        <option id="orissa1" style="display: none">Jagatsinghapur</option>
                                                                        <option id="orissa1" style="display: none">Khordha</option>
                                                                        <option id="orissa1" style="display: none">Keonjhar </option>
                                                                        <option id="orissa1" style="display: none">Kalahandi</option>
                                                                        <option id="orissa1" style="display: none">Kandhamal</option>
                                                                        <option id="orissa1" style="display: none">Koraput</option>
                                                                        <option id="orissa1" style="display: none">Kendrapara</option>
                                                                        <option id="orissa1" style="display: none">Malkangiri</option>
                                                                        <option id="orissa1" style="display: none">Mayurbhanj</option>
                                                                        <option id="orissa1" style="display: none">Nabarangpur</option>
                                                                        <option id="orissa1" style="display: none">Nuapada</option>
                                                                        <option id="orissa1" style="display: none">Nayagarh</option>
                                                                        <option id="orissa1" style="display: none">Puri</option>
                                                                        <option id="orissa1" style="display: none">Rayagada</option>
                                                                        <option id="orissa1" style="display: none">Sambalpur</option>
                                                                        <option id="orissa1" style="display: none">Subarnapur </option>
                                                                        <option id="orissa1" style="display: none">Sundargarh</option>
                                                                        
                                                                        <!--Gujarat(l)-->
                                                                        
                                                                        <option id="gujarat1" style="display: none">Ahmedabad</option>
                                                                        <option id="gujarat1" style="display: none">Amreli</option>
                                                                        <option id="gujarat1" style="display: none">Anand</option>
                                                                        <option id="gujarat1" style="display: none">Aravalli</option>
                                                                        <option id="gujarat1" style="display: none">Banaskantha</option>
                                                                        <option id="gujarat1" style="display: none">Bharuch</option>
                                                                        <option id="gujarat1" style="display: none">Bhavnagar</option>
                                                                        <option id="gujarat1" style="display: none">Botad</option>
                                                                        <option id="gujarat1" style="display: none">Chhota Udaipur</option>
                                                                        <option id="gujarat1" style="display: none">Dahod</option>
                                                                        <option id="gujarat1" style="display: none">Dang</option>
                                                                        <option id="gujarat1" style="display: none">Devbhoomi Dwarka</option>
                                                                        <option id="gujarat1" style="display: none">Gandhinagar</option>
                                                                        <option id="gujarat1" style="display: none">Gir Somnath</option>
                                                                        <option id="gujarat1" style="display: none">Jamnagar</option>
                                                                        <option id="gujarat1" style="display: none">Junagadh</option>
                                                                        <option id="gujarat1" style="display: none">Kutch</option>
                                                                        <option id="gujarat1" style="display: none">Kheda</option>
                                                                        <option id="gujarat1" style="display: none">Mahisagar</option>
                                                                        <option id="gujarat1" style="display: none">Mehsana</option>
                                                                        <option id="gujarat1" style="display: none">Morbi</option>
                                                                        <option id="gujarat1" style="display: none">Narmada</option>
                                                                        <option id="gujarat1" style="display: none">Navsari</option>
                                                                        <option id="gujarat1" style="display: none">Panchmahal</option>
                                                                        <option id="gujarat1" style="display: none">Patan</option>
                                                                        <option id="gujarat1" style="display: none">Porbandar</option>
                                                                        <option id="gujarat1" style="display: none">Rajkot</option>
                                                                        <option id="gujarat1" style="display: none">Sabarkantha</option>
                                                                        <option id="gujarat1" style="display: none">Surat</option>
                                                                        <option id="gujarat1" style="display: none">Surendranagar</option>
                                                                        <option id="gujarat1" style="display: none">Tapi</option>
                                                                        <option id="gujarat1" style="display: none">Vadodara</option>
                                                                        <option id="gujarat1" style="display: none">Valsad</option>
                                                                        
                                                                        <!--Haryana(m)-->
                                                                        
                                                                        <option id="haryana1" style="display: none">Ambala</option>
                                                                        <option id="haryana1" style="display: none">Bhiwani</option>
                                                                        <option id="haryana1" style="display: none">Charkhi Dadri</option>
                                                                        <option id="haryana1" style="display: none">Faridabad</option>
                                                                        <option id="haryana1" style="display: none">Fatehabad</option>
                                                                        <option id="haryana1" style="display: none">Gurugram</option>
                                                                        <option id="haryana1" style="display: none">Hisar</option>
                                                                        <option id="haryana1" style="display: none">Jhajjar</option>
                                                                        <option id="haryana1" style="display: none">Jind</option>
                                                                        <option id="haryana1" style="display: none">Kaithal</option>
                                                                        <option id="haryana1" style="display: none">Karnal</option>
                                                                        <option id="haryana1" style="display: none">Kurukshetra</option>
                                                                        <option id="haryana1" style="display: none">Mahendragarh</option>
                                                                        <option id="haryana1" style="display: none">Nuh</option>
                                                                        <option id="haryana1" style="display: none">Palwal</option>
                                                                        <option id="haryana1" style="display: none">Panchkula</option>
                                                                        <option id="haryana1" style="display: none">Panipat</option>
                                                                        <option id="haryana1" style="display: none">Rewari</option>
                                                                        <option id="haryana1" style="display: none">Rohtak</option>
                                                                        <option id="haryana1" style="display: none">Sirsa</option>
                                                                        <option id="haryana1" style="display: none">Sonipat</option>
                                                                        <option id="haryana1" style="display: none">Yamunanagar</option>
                                                                        
                                                                        <!--Uttarakand(n)-->
                                                                        
                                                                        <option id="uttarakand1" style="display: none">Almora</option>
                                                                        <option id="uttarakand1" style="display: none">Bageshwar</option>
                                                                        <option id="uttarakand1" style="display: none">Chamoli</option>
                                                                        <option id="uttarakand1" style="display: none">Champawat</option>
                                                                        <option id="uttarakand1" style="display: none">Dehradun</option>
                                                                        <option id="uttarakand1" style="display: none">Haridwar</option>
                                                                        <option id="uttarakand1" style="display: none">Nainital</option>
                                                                        <option id="uttarakand1" style="display: none">Pauri Garhwal</option>
                                                                        <option id="uttarakand1" style="display: none">Pithoragarh</option>
                                                                        <option id="uttarakand1" style="display: none">Rudraprayag</option>
                                                                        <option id="uttarakand1" style="display: none">Tehri Garhwal</option>
                                                                        <option id="uttarakand1" style="display: none">Udham Singh Nagar</option>
                                                                        <option id="uttarakand1" style="display: none">Uttarkashi</option>
                                                                        
                                                                        <!--Himachal Pradesh(o)-->
                                                                        
                                                                        <option id="himachal_pradesh1" style="display: none">Bilaspur</option>
                                                                        <option id="himachal_pradesh1" style="display: none">Chamba</option>
                                                                        <option id="himachal_pradesh1" style="display: none">Hamirpur</option>
                                                                        <option id="himachal_pradesh1" style="display: none">Kangra</option>
                                                                        <option id="himachal_pradesh1" style="display: none">Kinnaur</option>
                                                                        <option id="himachal_pradesh1" style="display: none">Kullu</option>
                                                                        <option id="himachal_pradesh1" style="display: none">Lahaul and Spiti</option>
                                                                        <option id="himachal_pradesh1" style="display: none">Mandi</option>
                                                                        <option id="himachal_pradesh1" style="display: none">Shimla</option>
                                                                        <option id="himachal_pradesh1" style="display: none">Sirmaur</option>
                                                                        <option id="himachal_pradesh1" style="display: none">Solan</option>
                                                                        <option id="himachal_pradesh1" style="display: none">Una</option>
                                                                        
                                                                        <!--Jammu and Kashmir(p)-->
                                                                        
                                                                        <option id="jammu_kashmir1" style="display: none">Doda</option>
                                                                        <option id="jammu_kashmir1" style="display: none">Jammu</option>
                                                                        <option id="jammu_kashmir1" style="display: none">Kathua</option>
                                                                        <option id="jammu_kashmir1" style="display: none">Poonch</option>
                                                                        <option id="jammu_kashmir1" style="display: none">Kishtwar</option>
                                                                        <option id="jammu_kashmir1" style="display: none">Rajouri</option>
                                                                        <option id="jammu_kashmir1" style="display: none">Ramban</option>
                                                                        <option id="jammu_kashmir1" style="display: none">Reasi</option>
                                                                        <option id="jammu_kashmir1" style="display: none">Samba</option>
                                                                        <option id="jammu_kashmir1" style="display: none">Udhampur</option>
                                                                        <option id="jammu_kashmir1" style="display: none">Anantnag</option>
                                                                        <option id="jammu_kashmir1" style="display: none">Bandipora</option>
                                                                        <option id="jammu_kashmir1" style="display: none">Baramulla</option>
                                                                        <option id="jammu_kashmir1" style="display: none">Budgam</option>
                                                                        <option id="jammu_kashmir1" style="display: none">Ganderbal</option>
                                                                        <option id="jammu_kashmir1" style="display: none">Kulgam</option>
                                                                        <option id="jammu_kashmir1" style="display: none">Kupwara</option>
                                                                        <option id="jammu_kashmir1" style="display: none">Pulwama</option>
                                                                        <option id="jammu_kashmir1" style="display: none">Shopian</option>
                                                                        <option id="jammu_kashmir1" style="display: none">Srinagar</option>
                                                                        <option id="jammu_kashmir1" style="display: none">Kargil</option>
                                                                        <option id="jammu_kashmir1" style="display: none">Leh</option>
                                                                        
                                                                        <!--Uttar Pradesh(q)-->
                                                                        
                                                                        <option id="uttar_pradesh1" style="display: none">Agra</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Aligarh</option>
                                                                        <option id="uttar_pradesh1" style="display: none">PrayagRaj</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Ambedkar Nagar</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Amroha</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Auraiya</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Azamgarh</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Badaun</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Bahraich</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Ballia</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Balrampur</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Banda District</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Barabanki</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Bareilly</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Bijnor</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Bulandshahr</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Chandauli</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Chitrakoot</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Deoria</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Etah</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Etawah</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Faizabad</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Farrukhabad</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Fatehpur</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Firozabad</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Gautam Buddha Nagar</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Ghaziabad</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Ghazipur</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Gonda</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Gorakhpur</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Hamirpur</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Hapur</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Hardoi</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Hathras</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Jaunpur </option>
                                                                        <option id="uttar_pradesh1" style="display: none">Jhansi</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Kannauj</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Kanpur Dehat</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Kanpur Nagar</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Kasganj</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Kaushambi</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Kushinagar</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Lakhimpur Kheri</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Lalitpur</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Lucknow</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Maharajganj</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Mahoba</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Mainpuri</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Mathura</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Mau</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Meerut</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Mirzapur</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Moradabad</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Muzaffarnagar</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Pilibhit</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Pratapgarh</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Rae Bareli</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Rampur</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Saharanpur</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Sant Kabir Nagar</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Sant Ravidas Nagar</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Sambhal</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Shahjahanpur</option>
                                                                        <option id="uttar_pradesh1" style="display: none">ShamliShravasti</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Shravasti</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Siddharthnagar</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Sitapur</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Sonbhadra</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Sultanpur</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Unnao</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Varanasi (Kashi)</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Allahabad</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Amethi</option>
                                                                        <option id="uttar_pradesh1" style="display: none">Bagpat</option>
                                                                        
                                                                        <!--Mizoram(r)-->
                                                                        
                                                                        <option id="mizoram1" style="display: none">Aizawl</option>
                                                                        <option id="mizoram1" style="display: none">Kolasib</option>
                                                                        <option id="mizoram1" style="display: none">Lawngtlai</option>
                                                                        <option id="mizoram1" style="display: none">Lunglei</option>
                                                                        <option id="mizoram1" style="display: none">Mamit</option>
                                                                        <option id="mizoram1" style="display: none">Saiha</option>
                                                                        <option id="mizoram1" style="display: none">Serchhip</option>
                                                                        <option id="mizoram1" style="display: none">Champhai</option>
                                                                        
                                                                        <!--Meghalaya(s)-->
                                                                        
                                                                        <option id="meghalaya1" style="display: none">East Garo Hills</option>
                                                                        <option id="meghalaya1" style="display: none">East Khasi Hills</option>
                                                                        <option id="meghalaya1" style="display: none">Jaintia Hills</option>
                                                                        <option id="meghalaya1" style="display: none">Ri Bhoi</option>
                                                                        <option id="meghalaya1" style="display: none">South Garo Hills </option>
                                                                        <option id="meghalaya1" style="display: none">West Garo Hills</option>
                                                                        <option id="meghalaya1" style="display: none">West Khasi Hills</option>



                                                                        <!--West Bengal(t)-->

                                                                        <option id="west_bengal1" style="display: none">Alipurduar</option>
                                                                        <option id="west_bengal1" style="display: none">Bankura</option>
                                                                        <option id="west_bengal1" style="display: none">Birbhum</option>
                                                                        <option id="west_bengal1" style="display: none">Cooch Behar</option>
                                                                        <option id="west_bengal1" style="display: none">Dakshin Dinajpur</option>
                                                                        <option id="west_bengal1" style="display: none">Darjeeling</option>
                                                                        <option id="west_bengal1" style="display: none">Hooghly</option>
                                                                        <option id="west_bengal1" style="display: none">Howrah</option>
                                                                        <option id="west_bengal1" style="display: none">Jalpaiguri</option>
                                                                        <option id="west_bengal1" style="display: none">Jhargram</option>
                                                                        <option id="west_bengal1" style="display: none">Kalimpong</option>
                                                                        <option id="west_bengal1" style="display: none">Kolkata</option>
                                                                        <option id="west_bengal1" style="display: none">Malda</option>
                                                                        <option id="west_bengal1" style="display: none">Murshidabad</option>
                                                                        <option id="west_bengal1" style="display: none">Nadia</option>
                                                                        <option id="west_bengal1" style="display: none">North 24 Parganas</option>
                                                                        <option id="west_bengal1" style="display: none">Paschim Bardhaman</option>
                                                                        <option id="west_bengal1" style="display: none">Paschim Medinipur</option>
                                                                        <option id="west_bengal1" style="display: none">Purba Bardhaman</option>
                                                                        <option id="west_bengal1" style="display: none">Purba Medinipur</option>
                                                                        <option id="west_bengal1" style="display: none">Purulia</option>
                                                                        <option id="west_bengal1" style="display: none">South 24 Parganas</option>
                                                                        <option id="west_bengal1" style="display: none">Uttar Dinajpur</option>
                                                                        

                                                                        <!--Tripura(u)-->

                                                                        <option id="tripura1" style="display: none">Dhalai</option>
                                                                        <option id="tripura1" style="display: none">North Tripura</option>
                                                                        <option id="tripura1" style="display: none">South Tripura</option>
                                                                        <option id="tripura1" style="display: none">West Tripura</option>


                                                                        <!--Nagaland(v)-->

                                                                        <option id="nagaland1" style="display: none">Dimapur</option>
                                                                        <option id="nagaland1" style="display: none">Kiphire</option>
                                                                        <option id="nagaland1" style="display: none">Kohima</option>
                                                                        <option id="nagaland1" style="display: none">Longleng</option>
                                                                        <option id="nagaland1" style="display: none">Mokokchung</option>
                                                                        <option id="nagaland1" style="display: none">Mon</option>
                                                                        <option id="nagaland1" style="display: none">Peren</option>
                                                                        <option id="nagaland1" style="display: none">Phek</option>
                                                                        <option id="nagaland1" style="display: none">Tuensang</option>
                                                                        <option id="nagaland1" style="display: none">Wokha</option>
                                                                        <option id="nagaland1" style="display: none">Zunheboto</option>
                                                                        <option id="nagaland1" style="display: none">Noklak</option>


                                                                        <!--Jharkhand(w)-->


                                                                        <option id="jharkhand1" style="display: none">Bokaro</option>
                                                                        <option id="jharkhand1" style="display: none">Chatra</option>
                                                                        <option id="jharkhand1" style="display: none">Deoghar</option>
                                                                        <option id="jharkhand1" style="display: none">Dhanbad</option>
                                                                        <option id="jharkhand1" style="display: none">Dumka</option>
                                                                        <option id="jharkhand1" style="display: none">East Singhbhum</option>
                                                                        <option id="jharkhand1" style="display: none">Garhwa</option>
                                                                        <option id="jharkhand1" style="display: none">Giridih</option>
                                                                        <option id="jharkhand1" style="display: none">Godda</option>
                                                                        <option id="jharkhand1" style="display: none">Gumla</option>
                                                                        <option id="jharkhand1" style="display: none">Hazaribagh</option>
                                                                        <option id="jharkhand1" style="display: none">Jamtara</option>
                                                                        <option id="jharkhand1" style="display: none">Khunti</option>
                                                                        <option id="jharkhand1" style="display: none">Koderma</option>
                                                                        <option id="jharkhand1" style="display: none">Latehar</option>
                                                                        <option id="jharkhand1" style="display: none">Lohardaga</option>
                                                                        <option id="jharkhand1" style="display: none">Pakur</option>
                                                                        <option id="jharkhand1" style="display: none">Palamu</option>
                                                                        <option id="jharkhand1" style="display: none">Ramgarh</option>
                                                                        <option id="jharkhand1" style="display: none">Ranchi</option>
                                                                        <option id="jharkhand1" style="display: none">Sahebganj</option>
                                                                        <option id="jharkhand1" style="display: none">Seraikela</option>
                                                                        <option id="jharkhand1" style="display: none">Simdega</option>
                                                                        <option id="jharkhand1" style="display: none">West Singhbhum</option>


                                                                        <!--Karnataka(x)-->

                                                                        <option id="karnataka1" style="display: none">Bagalkote</option>
                                                                        <option id="karnataka1" style="display: none">Bangalore Rural</option>
                                                                        <option id="karnataka1" style="display: none">Bangalore Urban</option>
                                                                        <option id="karnataka1" style="display: none">Belagavi</option>
                                                                        <option id="karnataka1" style="display: none">Bellary</option>
                                                                        <option id="karnataka1" style="display: none">Bidar</option>
                                                                        <option id="karnataka1" style="display: none">Bijapur</option>
                                                                        <option id="karnataka1" style="display: none">Chamarajanagar</option>
                                                                        <option id="karnataka1" style="display: none">Chikkamagaluru</option>
                                                                        <option id="karnataka1" style="display: none">Chitradurga</option>
                                                                        <option id="karnataka1" style="display: none">Dakshina Kannada</option>
                                                                        <option id="karnataka1" style="display: none">Davanagere </option>
                                                                        <option id="karnataka1" style="display: none">Dharwad</option>
                                                                        <option id="karnataka1" style="display: none">Gadag</option>
                                                                        <option id="karnataka1" style="display: none">Gulbarga</option>
                                                                        <option id="karnataka1" style="display: none">Hassan</option>
                                                                        <option id="karnataka1" style="display: none">Haveri</option>
                                                                        <option id="karnataka1" style="display: none">Kodagu</option>
                                                                        <option id="karnataka1" style="display: none">Kolar</option>
                                                                        <option id="karnataka1" style="display: none">Koppal</option>
                                                                        <option id="karnataka1" style="display: none">Mandya</option>
                                                                        <option id="karnataka1" style="display: none">Mysore</option>
                                                                        <option id="karnataka1" style="display: none">Raichur</option>
                                                                        <option id="karnataka1" style="display: none">Shimoga</option>
                                                                        <option id="karnataka1" style="display: none">Tumkur</option>
                                                                        <option id="karnataka1" style="display: none">Udupi</option>
                                                                        <option id="karnataka1" style="display: none">Uttara Kannada</option>


                                                                        <!--Bihar(y)-->

                                                                        <option id="bihar1" style="display: none">Araria</option>
                                                                        <option id="bihar1" style="display: none">Madhepura</option>
                                                                        <option id="bihar1" style="display: none">Arwal</option>
                                                                        <option id="bihar1" style="display: none">Madhubani</option>
                                                                        <option id="bihar1" style="display: none">Aurangabad</option>
                                                                        <option id="bihar1" style="display: none">Monghyr</option>
                                                                        <option id="bihar1" style="display: none">Banka</option>
                                                                        <option id="bihar1" style="display: none">Muzaffarpur</option>
                                                                        <option id="bihar1" style="display: none">Begusarai</option>
                                                                        <option id="bihar1" style="display: none">Nalanda</option>
                                                                        <option id="bihar1" style="display: none">Bhagalpur</option>
                                                                        <option id="bihar1" style="display: none">Nawada</option>
                                                                        <option id="bihar1" style="display: none">Bhojpur</option>
                                                                        <option id="bihar1" style="display: none">Patna</option>
                                                                        <option id="bihar1" style="display: none">Buxar</option>
                                                                        <option id="bihar1" style="display: none">Purnea</option>
                                                                        <option id="bihar1" style="display: none">Darbhanga</option>
                                                                        <option id="bihar1" style="display: none">Rohtas</option>
                                                                        <option id="bihar1" style="display: none">East Champaran</option>
                                                                        <option id="bihar1" style="display: none">Saharsa</option>
                                                                        <option id="bihar1" style="display: none">Gaya</option>
                                                                        <option id="bihar1" style="display: none">Samastipur</option>
                                                                        <option id="bihar1" style="display: none">Gopalganj</option>
                                                                        <option id="bihar1" style="display: none">Saran</option>
                                                                        <option id="bihar1" style="display: none">Jamui</option>
                                                                        <option id="bihar1" style="display: none">Shiekhpura</option>
                                                                        <option id="bihar1" style="display: none">Jehanabad</option>
                                                                        <option id="bihar1" style="display: none">Sheohar</option>
                                                                        <option id="bihar1" style="display: none">Kaimur</option>
                                                                        <option id="bihar1" style="display: none">Sitamarhi</option>
                                                                        <option id="bihar1" style="display: none">Katihar</option>
                                                                        <option id="bihar1" style="display: none">Siwan</option>
                                                                        <option id="bihar1" style="display: none">Khagaria</option>
                                                                        <option id="bihar1" style="display: none">Supaul</option>
                                                                        <option id="bihar1" style="display: none">Kishanganj</option>
                                                                        <option id="bihar1" style="display: none">Vaishali</option>
                                                                        <option id="bihar1" style="display: none">Lakhisarai</option>
                                                                        <option id="bihar1" style="display: none">West Champaran</option>

                                                                        <!--Manipur(z)-->

                                                                        <option  id="manipur1" style="display: none">Bishnupur</option>
                                                                        <option  id="manipur1" style="display: none">Chandel Chandel</option>
                                                                        <option  id="manipur1" style="display: none">Churachandpur</option>
                                                                        <option  id="manipur1" style="display: none">Imphal East</option>
                                                                        <option  id="manipur1" style="display: none">Imphal West</option>
                                                                        <option  id="manipur1" style="display: none">Senapati</option>
                                                                        <option  id="manipur1" style="display: none">Tamenglong</option>
                                                                        <option  id="manipur1" style="display: none">Thoubal</option>
                                                                        <option  id="manipur1" style="display: none">Ukhrul</option>
                                                                        <option  id="manipur1" style="display: none">Jiribam</option>
                                                                        <option  id="manipur1" style="display: none">Kangpokpi</option>
                                                                        <option  id="manipur1" style="display: none">Kakching</option>
                                                                        <option  id="manipur1" style="display: none">Tengnoupal</option>
                                                                        <option  id="manipur1" style="display: none">Kamjong</option>
                                                                        <option  id="manipur1" style="display: none">Noney</option>
                                                                        <option  id="manipur1" style="display: none">Pherzawl</option>

                                                                        <!--Sikkim(aa)-->
                                                                        
                                                                        <option id="sikkim1" style="display: none">East Sikkim</option>
                                                                        <option id="sikkim1" style="display: none">North Sikkim</option>
                                                                        <option id="sikkim1" style="display: none">South Sikkim</option>
                                                                        <option id="sikkim1" style="display: none">West Sikkim</option>

                                                                        <!--Telangana(bb)-->
                                                                        
                                                                        <option id="telangana1" style="display: none">Adilabad</option>
                                                                        <option id="telangana1" style="display: none">Bhadradri Kothagudem</option>
                                                                        <option id="telangana1" style="display: none">Hyderabad</option>
                                                                        <option id="telangana1" style="display: none">Jagtial</option>
                                                                        <option id="telangana1" style="display: none">Jangaon</option>
                                                                        <option id="telangana1" style="display: none">Jayashankar Bhupalpally</option>
                                                                        <option id="telangana1" style="display: none">Jogulamba Gadwal</option>
                                                                        <option id="telangana1" style="display: none">Kamareddy</option>
                                                                        <option id="telangana1" style="display: none">Karimnagar</option>
                                                                        <option id="telangana1" style="display: none">Khammam</option>
                                                                        <option id="telangana1" style="display: none">Kumuram Bheem</option>
                                                                        <option id="telangana1" style="display: none">Mahabubabad</option>
                                                                        <option id="telangana1" style="display: none">Mahabubnagar</option>
                                                                        <option id="telangana1" style="display: none">Mancherial</option>
                                                                        <option id="telangana1" style="display: none">Medak</option>
                                                                        <option id="telangana1" style="display: none">Medchal</option>
                                                                        <option id="telangana1" style="display: none">Mulugu</option>
                                                                        <option id="telangana1" style="display: none">Nagarkurnool</option>
                                                                        <option id="telangana1" style="display: none">Nalgonda</option>
                                                                        <option id="telangana1" style="display: none">Narayanpet</option>
                                                                        <option id="telangana1" style="display: none">Nirmal</option>
                                                                        <option id="telangana1" style="display: none">Nizamabad</option>
                                                                        <option id="telangana1" style="display: none">Peddapalli</option>
                                                                        <option id="telangana1" style="display: none">Rajanna Sircilla</option>
                                                                        <option id="telangana1" style="display: none">Rangareddy</option>
                                                                        <option id="telangana1" style="display: none">Sangareddy</option>
                                                                        <option id="telangana1" style="display: none">Siddipet</option>
                                                                        <option id="telangana1" style="display: none">Suryapet</option>
                                                                        <option id="telangana1" style="display: none">Vikarabad</option>
                                                                        <option id="telangana1" style="display: none">Wanaparthy</option>
                                                                        <option id="telangana1" style="display: none">Warangal (Rural)</option>
                                                                        <option id="telangana1" style="display: none">Warangal (Urban)</option>
                                                                        <option id="telangana1" style="display: none">Yadadri Bhuvanagiri</option>

                                                                        <!--Madhya Pradesh(cc)-->

                                                                        <option id="madhya_pradesh1" style="display: none">Agar Malwa</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Alirajpur</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Anuppur</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Ashoknagar</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Balaghat</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Barwan</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Betul</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Bhind</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Bhopal</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Burhanpur</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Chhatarpur</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Chhindwara</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Damoh</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Datia</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Dewas</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Dhar</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Dindori</option>
                                                                        <option id="madhya_pradesh1" style="display: none">East Nimar</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Guna</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Gwalior</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Harda</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Hoshangabad</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Indore</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Jabalpur</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Jhabua</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Katni</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Mandla</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Mandsaur</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Morena</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Narsinghpur</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Neemuch</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Niwari</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Panna</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Raisen</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Rajgarh</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Ratlam</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Rewa</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Sagar</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Satna</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Sehore</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Seoni</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Shahdol</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Shajapur</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Sheopur</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Shivpuri</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Sidhi</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Singrauli</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Tikamgarh</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Ujjain</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Umaria</option>
                                                                        <option id="madhya_pradesh1" style="display: none">Vidisha</option>
                                                                        <option id="madhya_pradesh1" style="display: none">West Nimar</option>
                                                ...
                                                <script type="text/javascript">
                                                                function check1 () 
                                                                     {
                                                                        var che = document.getElementById("p_inputState").value;
                                                                        var a = document.querySelectorAll("[id='tamil_nadu1']");
                                                                        var b = document.querySelectorAll("[id='kerela1']");
                                                                        var c = document.querySelectorAll("[id='punjab1']");
                                                                        var d = document.querySelectorAll("[id='rajasthan1']");
                                                                        var e =document.querySelectorAll("[id='andhra1']");
                                                                        var f = document.querySelectorAll("[id='arunachal1']");
                                                                        var g = document.querySelectorAll("[id='assam1']");
                                                                        var h = document.querySelectorAll("[id='goa1']");
                                                                        var ii = document.querySelectorAll("[id='maharashtra1']");
                                                                        var j = document.querySelectorAll("[id='Chattisgarh1']");
                                                                        var k = document.querySelectorAll("[id='orissa1']");
                                                                        var l = document.querySelectorAll("[id='gujarat1']");
                                                                        var m = document.querySelectorAll("[id='haryana1']");
                                                                        var n = document.querySelectorAll("[id='uttarakand1']");
                                                                        var o = document.querySelectorAll("[id='himachal_pradesh1']");
                                                                        var p = document.querySelectorAll("[id='jammu_kashmir1']");
                                                                        var q = document.querySelectorAll("[id='uttar_pradesh1']");
                                                                        var r = document.querySelectorAll("[id='mizoram1']");
                                                                        var s = document.querySelectorAll("[id='meghalaya1']");
                                                                        var t = document.querySelectorAll("[id='west_bengal1']");
                                                                        var u = document.querySelectorAll("[id='tripura1']");
                                                                        var v = document.querySelectorAll("[id='nagaland1']");
                                                                        var w = document.querySelectorAll("[id='jharkhand1']");
                                                                        var x = document.querySelectorAll("[id='karnataka1']");
                                                                        var y = document.querySelectorAll("[id='bihar1']");
                                                                        var z = document.querySelectorAll("[id='manipur1']");
                                                                        var aa = document.querySelectorAll("[id='sikkim1']");
                                                                        var bb = document.querySelectorAll("[id='telangana1']");
                                                                        var cc = document.querySelectorAll("[id='madhya_pradesh1']");
                                                                ...
                                                                <div class="form-group mb-4">
                                                                    ...
                                                                    <div class="col-md-12">
                                                                    <input type="text" class="form-control" id="inputZip" name="p_zip" >
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            </div>
                                                              ...
                                                              function yesnoCheck()
                                                             {
                                                              if (document.getElementById('customRadio12').checked) {
