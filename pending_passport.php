...
$query="SELECT * FROM passport_details where status='application received' or status='under verification'";
                                ...
                                <div class="card">
                                    <div class="card-body">
                                              ...
                                              <form class="needs-validation" novalidate>
                                                ...
                                                <label><h3>Passport Applications (Verification Pending)</h3></label>
                                                <br><br>
                                                ...
                                                while ($rows=mysqli_fetch_assoc($result)) 
                                               {
                                                ...
                                                <tr >
                                                    ...
                                                    <td align="center" ><a href="pending_passport_users.php?uname=<?php echo $rows['username']; ?> " class="btn btn-primary">Verify</a></td>
                                                ...
                                                <div id="display" style="display: none">
                                                    <p>HEY javascript is working</p>
                                                </div>


                                                <div id="displa" style="display: none">
                                                    <p>HEY  is working</p>
                                                </div>
