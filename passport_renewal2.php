                            ...
                            <div class="col-12">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="form-group mb-4">
                                                                    ...
                                                                    <select id="inputState" class="form-control" required>
                                                                        ...
                                                                        <option value="kj">Option 1</option>
                                                                        <option value="rt">Option 2</option>
                                                                        <option value="yt">Option 3</option>
                                                                    </select>
                                                                    </div>
                                                                </div>
                                                                </div>
                              ...
                              function yesnoCheck()
                                                     ...
                                                     <ul class="list-inline wizard mb-0">
                                                        ...
                                                        <li class="next list-inline-item float-right"><button type="submit" class="btn btn-info">Next</button>></li>
                                                    </ul>
