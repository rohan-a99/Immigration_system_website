                                                        ...
                                                        <form id="passForm" method="post" action="Passport1.php" class="form-horizontal">
                                                            <div class="row">
                                                                ...
                                                                <div class="custom-control custom-radio custom-control-inline">
                                                                    <input type="radio" id="customRadio3" name="book_type" class="custom-control-input" value="36" required>
                                                                    <label class="custom-control-label" for="customRadio3">36 Pages</label>
                                                                </div> 
                                                                <div class="custom-control custom-radio custom-control-inline">
                                                                    <input type="radio" id="customRadio4" name="book_type" class="custom-control-input" value="60" required>
                                                                ...
                                                                <div class="custom-control custom-radio custom-control-inline">
                                                                    <input type="radio" id="customRadio1" name="n_ecr" class="custom-control-input" value="y" required>
                                                                    <label class="custom-control-label" for="customRadio1">Yes</label>
                                                                </div> 
                                                                <div class="custom-control custom-radio custom-control-inline">
                                                                    <input type="radio" id="customRadio13" name="n_ecr" class="custom-control-input" value="n" required>
                                                              ...
                                                              <ul class="list-inline wizard mb-0">
                                                                  ...
                                                                  <li class="next list-inline-item float-right"><a href="new-passport2.php"><button class="btn btn-info" type="submit">Next</button></a></li>
                                                    </ul>
                                                         </form>
                                                    </div>
