                                        ...
                                        <h4 class="header-title mb-3">Passport Renewal Application</h4>
                                            ...
                                            <div id="rootwizard">
                                                ...
                                                <div class="tab-pane fade" id="third">
                                                        <form id="otherForm" method="post" action="passren_1.php" class="form-horizontal">
                                                            <div class="row">
                                                              ...
                                                              <div class="col">
                                                                    <div class="form-group mb-3">
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <input type="text" class="form-control" data-toggle="input-mask" name="p_nm" data-mask-format="0000-0000" required>
                                                                        </div>
                                                                    </div>
                                                                </div> <!-- end col -->
                                                                ...
                                                                <div class="form-group mb-4">
                                                                    ...
                                                                    <div class="col-md-12">
                                                                    <select id="inputState" class="form-control" name="p_off" required>
                                                                ...
                                                                <div class="col">
                                                                    <div class="form-group mb-3">
                                                                        ...
                                                                        <div class="col-md-9">
                                                                            <input class="form-control" id="example-date" type="date" name="doi" required>
                                                                        </div>
                                                                    </div>
                                                                </div> <!-- end col -->
                                                                ...
                                                                <div class="col">
                                                                    <div class="form-group mb-3">
                                                                        ...
                                                                        <div class="col-md-9">
                                                                            <input class="form-control" id="example-date" type="date" name="doe" required>
                                                                        </div>
                                                                    </div>
                                                                </div> <!-- end col -->
                                                    ...
                                                    <ul class="list-inline wizard mb-0">
                                                        ...
                                                        <li class="next list-inline-item float-right"><a href="passren_1.php"><button class="btn btn-info" type="submit">Next</button></a></li>
                                                    </ul>
